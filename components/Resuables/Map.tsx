...
export default function MapSection({showMapImmediately}: { showMapImmediately?: boolean }) {
    return (
        <section className="py-16 lg:py-24">
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <motion.div
                    ...
                    initial={{opacity: 0, y: 20}}
                    whileInView={{opacity: 1, y: 0}}
                    viewport={{once: true, amount: showMapImmediately ? 0.0 : 0.2}}
...
export function XtraMap({options}: {
